    ...
    <div>
      ...
      >
        ...
        <template #operation="scope">
          ...
          <el-button type="primary" link :icon="Delete" @click="deleteById(scope.row.id)">删除</el-button>
        </template>
      </ProTable>
    </div>
...
import { getAll,getModel,addMany,deleteMany,addMater,editMater,deleteById } from "@/api/modules/mater";
