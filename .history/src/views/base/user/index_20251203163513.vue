...
import { rolesMap,getRoles,savePower } from "@/api/modules/system/role";
...
import { CirclePlus, Delete, EditPen, SoldOut, View } from "@element-plus/icons-vue";
...
onMounted(async () => {
  await dictStore.loadDicts(['role']);
   ...
   roleList.value = await (await getRoles()).data;
   console.log(roleList.value)//有值
});
