  ...
  >
    ...
    >
      <el-form-item label="请购人" prop="applyUserId">
        ...
        >
          <el-option 
            v-for="item in dictStore.dictMap['staff']"  
            :key="item.value" 
            :value="item.value" 
          />
        </el-select>
...
const acceptParams = (params) => {
  ...
  // 当前用户作为申请人
  form.value.applyUserId = authStore.userInfo.id;

  if (params.title === "新增") {
    Object.assign(form.value, {
      id: null,
      applyUserId: authStore.userInfo.id,
      itemName: "",
      itemSpec: "",
      itemUnit: "",
      itemNumber: 1,
