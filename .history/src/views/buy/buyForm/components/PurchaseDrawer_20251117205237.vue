<template>
  ...
  >
    ...
    <el-form-item label="封面图片" prop="coverImg" :rules="[{ required: true, message: '请上传封面图片' }]">
      <UploadImg 
...
import { addPurchase, updatePurchase } from "@/api/modules/buy/buy";
import { ElMessage } from "element-plus";
import UploadImg from "@/components/Upload/Img.vue";  // 路径根据实际位置调整
