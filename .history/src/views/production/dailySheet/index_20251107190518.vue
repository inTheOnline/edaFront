    ...
    <div>
      ...
      >
        <template #tableHeader="scope">
          ...
          <el-button type="primary" :icon="Upload" plain @click="batchAdd">导入生产记录</el-button>
          <el-button type="primary" :icon="Upload" plain @click="batchAdd">导入生产记录</el-button>
          <el-button type="primary" :icon="Download" plain @click="downloadFile">导出生产数据</el-button>批量添加
          <el-button
            type="danger"
            :icon="Delete"
            plain
