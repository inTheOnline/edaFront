...
export const addOfficePurchase = (data: OfficePurchase) => {
  return http.post<OfficePurchasePageResult>("/officePurchase/add", data);
};

// 批量新增
export const addBatchOfficePurchase = (data: OfficePurchase[]) => {
  return http.post<OfficePurchasePageResult>("/officePurchase/addBatch", data);
};

// 批量删除
export const deleteBatchOfficePurchase = (ids: number[]) => {
  return http.post<OfficePurchasePageResult>("/officePurchase/deleteBatch", ids);
};

// 单个删除
export const deleteOfficePurchase = (id: number) => {
  return http.delete<OfficePurchasePageResult>(`/officePurchase/delete/${id}`);
};

// 编辑
export const editOfficePurchase = (data: OfficePurchase) => {
  return http.put<OfficePurchasePageResult>("/officePurchase/edit", data);
};
