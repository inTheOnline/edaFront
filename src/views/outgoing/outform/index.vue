<template>
  <div class="outform">
    <TreeFilter class="tree" label="supName" value="id" title="产品列表(单选)" :request-api="supTreeApi" @change="changeTreeFilter" />
    <div class="table-box">
      <ProTable
        :columns="columns"
      ...
      >
        ...
        <template #expand="scope">
          <div class="expand_div">
            <el-table :data="scope.row.maters" class="expand" style="width: 100%" v-show="scope.row.maters.length > 0">
              ...
              <el-table-column class="column" align="center" prop="number" label="外发数量" />
        ...
        <template #tableHeader="scope">
          ...
          <el-button type="primary" :icon="Download" plain @click="updataList(scope.selectedList)">导出订单</el-button>
          <el-button
            type="danger"
            :icon="Delete"
            plain
...
import { outFormApi, custDetailApi, getStateApi, getSupMapApi, addOutform, supTreeApi, deleteList,edit } from "@/api/modules/outgoing";
...
const columns: ColumnProps[] = reactive([
  ...
  { label: "外发单号", prop: "subcNum", width: 300 },
