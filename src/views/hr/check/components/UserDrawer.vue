  ...
  <el-drawer v-model="drawerVisible" :destroy-on-close="true" size="500px" :title="`${drawerProps.title}职工`">
    ...
    >
      ...
      <el-form-item label="部门" prop="departmentId">
        <el-select v-model="drawerProps.row.departmentId" placeholder="请选择供应商" clearable>
      ...
      <el-form-item label="状态" prop="state">
        <!-- <el-input v-model="drawerProps.row.state" placeholder="请选择状态" clearable></el-input> -->
...
const rules = reactive({
  ...
  live: [{ required: false, message: "请填写宿舍号" }],
